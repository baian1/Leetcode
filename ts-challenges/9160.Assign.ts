...
type merge<T,P,Key extends string|number|symbol = keyof T | keyof P> = {
  [K in Key]:K extends keyof P?P[K]:K extends keyof T?T[K]:never;
}

type Assign<T extends Record<string, unknown>, U> = U extends [infer L extends Record<PropertyKey,unknown>,...infer R]?Assign<merge<T,L>,R>:T;
