...
import { AddOne } from "./utils/number"


/* _____________ Your Code Here _____________ */

type NumberRange<L extends number, H extends number, Cur extends number = L, Res = never> = Cur extends H ? Res | Cur : NumberRange<L, H, AddOne<Cur>, Res | Cur>
