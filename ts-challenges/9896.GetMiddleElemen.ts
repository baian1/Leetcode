...
type GetMiddleElement<T> = T extends [infer H, ...infer Other, infer E]
  ? More<3, Other["length"]> extends Ordering.Greater
    ? Other extends []
      ? T
      : Other
...
import { Ordering } from "./utils/common";
import { More } from "./utils/number";
