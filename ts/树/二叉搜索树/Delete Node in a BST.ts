...
var deleteNode = function (root: TreeNode, key: number) {
  ...
  if (node.left !== null && node.right !== null) {
    ...
    deleteNode(preleftNode, <number>leftTreeMaxNode.val);
    node.val = leftTreeMaxNode.val;
    return root;
...
const deleteNode2 = function (
  ...
  if (root.val > key) {
    ...
    if (root.left !== null && root.right !== null) {
      ...
      root.left = deleteNode2(root.right, <number>leftMax.val);
    } //寻找左树最大值替换根结点
    else {
